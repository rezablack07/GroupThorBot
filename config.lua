return {
	bot_api_key = 'token-from-botfather',
	version = '2.0 GroupThorBot based on v3.1', 
	testing_mode = false,
	admin = {
		owner = 0,
		admins = {
	...
	log_chat = -1001055969550, -- Enter group id here and set bot as admin
	channel = '@eventh0rizon', --channel username with the '@'
	help_group = 'https://telegram.me/groupthorsupport', --group link, not username!
